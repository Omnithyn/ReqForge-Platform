...
from src.schema import PolicyBinding  # noqa: E402
from src.instances import EntityInstance, FactRecord  # noqa: E402
...
def build_ontology_policy_binding(
    ...
    """构建本体层策略绑定。"""
    from src.instances import generate_instance_id
