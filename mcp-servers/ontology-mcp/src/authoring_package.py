...
from src.edge_semantics import (
    EdgeCompilationResult,
    compile_edges_from_visual_graph,
)
from src.roundtrip import visual_graph_to_schema
...
from src.visual_model import VisualGraph

# N1.7: RelationType 在 core.meta_model 中定义
from .stubs import RelationType
...
def load_authoring_package(
    ...
    Returns:
        AuthoringPackage
    """
    from src.visual_model import VisualGraph, VisualNode, VisualEdge
