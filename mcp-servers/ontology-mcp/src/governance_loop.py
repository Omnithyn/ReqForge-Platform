...
from src.authoring_package import RuntimePackage
from src.schema import OntologySchema, PolicyBinding
from src.loader import load_ontology_schema  # noqa: E402
...
def run_minimal_ontology_governance(
    ...
    if schema_dir is None:
        from src.loader import SCHEMA_DIR
    ...
    if runtime_package.policy_bindings and establishment_result:
        ...
        for policy_binding in runtime_package.policy_bindings:
            ...
            if judgment_mode == "review":
                # 强制标记为 review
                from src.policy_binding import build_policy_judgment
                if judgment.judgment_result == "pass":
